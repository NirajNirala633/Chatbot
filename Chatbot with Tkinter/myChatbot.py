...
class chatbot:
    def __init__(self,root):
        ...
        #--------------------Title----------------
        lbl_title = Label(self.root,text='ChatGPT Developed By Neo',font=('times new roman',20,'bold'))
...
# -------------------Functions starts--------------------
    ...
    def send(self):
        ...
        input_list = ['hi','hey','hello','how are you','whats up']
        output_list = ['hello','good to see you','nice to see you','hi','good to meet you']
